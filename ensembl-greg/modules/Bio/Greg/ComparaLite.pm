...
sub load_tree_for_analysis {
  ...
  if ( defined $aln_file ) {
    ...
    Bio::EnsEMBL::Compara::ComparaUtils->store_SimpleAlign_into_table( "protein_tree_member", $node,
      $sa );
  }
...
sub load_trees_for_simulation {
  ...
  foreach my $file ( sort @files ) {
    ...
    foreach my $sim_set (@simulation_sets) {
      ...
      my $sim_params =
        Bio::EnsEMBL::Compara::ComparaUtils->load_params_from_string( $temp_sim_params,
        $sim_param_str );
