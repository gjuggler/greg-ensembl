...
=head2 hmm
 ...
 Arg1: string, type of tree the HMM is associated with (default: FULL)
 Arg2: (optional) string, a HMM in HMMER ASCII format
 Description: Gets/sets a HMM for a family
